                    ...
                    <tbody>
                         ...
                         <tr>
                              ...
                              <td data-search="{{ $item->description }}">
                                  <?php $smallCover = empty($item->cover)? url('images/noimg.png') : getArticleCover($item->cover, 's');
                                        $largeCover = empty($item->cover)? url('images/noimg.png') : getArticleCover($item->cover); ?>
